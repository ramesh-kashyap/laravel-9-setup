...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('') }}upnl/app-assets/vendors/css/charts/apexcharts.css">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('') }}upnl/app-assets/vendors/css/extensions/toastr.min.css">
    <link rel="stylesheet" type="text/css"
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('') }}upnl/app-assets/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('') }}upnl/app-assets/css/bootstrap-extended.min.css">
    <link rel="stylesheet" type="text/css" href="{{ asset('') }}upnl/app-assets/css/colors.min.css">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('') }}upnl/app-assets/css/components.min.css">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('') }}upnl/app-assets/css/themes/dark-layout.min.css">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('') }}upnl/app-assets/css/themes/bordered-layout.min.css">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('') }}upnl/app-assets/css/themes/semi-dark-layout.min.css">

    <link rel="stylesheet" type="text/css"
        href="{{ asset('') }}upnl/app-assets/css/core/menu/menu-types/vertical-menu.min.css">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('') }}upnl/app-assets/css/pages/dashboard-ecommerce.min.css">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('') }}upnl/app-assets/css/plugins/charts/chart-apex.min.css">
    <link rel="stylesheet" type="text/css"
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('') }}upnl/app-assets/css/pages/app-ecommerce.min.css">
            ...
            <ul class="nav navbar-nav align-items-center ms-auto">
                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                        ...
                        <div class="user-nav d-sm-flex d-none"><span
                                ...
                                class="user-status">{{ Auth::user()->username }}</span></div><span
                            class="avatar"><img class="round"
                                src="{{ asset('') }}upnl/app-assets/images/portrait/small/avatar-s-11.jpg"
        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item me-auto"><a class="navbar-brand"
                        href="{{ route('user.dashboard') }}"><span class="brand-logo">
                            <img src="{{ asset('') }}upnl/app-assets/images/logo/logov.png" alt=""
                                width="180"></span>
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class=" nav-item"><a class="d-flex align-items-center"
                        href="{{ route('user.dashboard') }}"><i data-feather="grid"></i><span
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="user"></i><span
                    ...
                    <ul class="menu-content">
                        <li><a class="d-flex align-items-center" href="{{ route('user.profile') }}"><i
                                    data-feather="circle"></i><span class="menu-item text-truncate"
                                    data-i18n="List">Profile Setting</span></a>
                        </li>
                        <li><a class="d-flex align-items-center"
                                href="{{ route('user.ChangePass') }}"><i
                                    data-feather="circle"></i><span class="menu-item text-truncate"
                                    data-i18n="Preview">Setting</span></a>
                        ...
                        <li><a class="d-flex align-items-center"
                                href="{{ route('user.BankDetail') }}"><i
                                    data-feather="circle"></i><span class="menu-item text-truncate"
                                    data-i18n="Preview">Bank Update</span></a>
                        </li>
                    </ul>
                </li>
                <li class=" navigation-header"><span data-i18n="Apps &amp; Pages">BUSINESS</span><i
                        data-feather="more-horizontal"></i>
                <li class=" nav-item"><a class="d-flex align-items-center"
                        href="{{ route('user.AddFund') }}"><i data-feather="dollar-sign"></i><span
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="key"></i><span
                    ...
                    <ul class="menu-content">
                        <li><a class="d-flex align-items-center" href="{{ route('user.invest') }}"><i
                                    data-feather="circle"></i><span class="menu-item text-truncate"
                                    data-i18n="Roles">Package Activation</span></a>
                        </li>
                        <li><a class="d-flex align-items-center"
                                href="{{ route('user.DepositHistory') }}"><i
                                    data-feather="circle"></i><span class="menu-item text-truncate"
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i
                    ...
                    <ul class="menu-content">
                        <li><a class="d-flex align-items-center"
                                href="{{ route('user.WithdrawRequest') }}"><i
                                    data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Shop">INR
                                    Withdrawal</span></a>
                        </li>
                        ...
                        <li><a class="d-flex align-items-center"
                                href="{{ route('user.WithdrawHistory') }}"><i
                                    data-feather="circle"></i><span class="menu-item text-truncate"
                                    data-i18n="Wish List">Withdrawal History</span></a>
                        </li>
                    </ul>
                </li>
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="users"></i><span
                    ...
                    <ul class="menu-content">
                        <li><a class="d-flex align-items-center"
                                href="{{ route('user.referral-team') }}"><i
                                    data-feather="circle"></i><span class="menu-item text-truncate"
                                    data-i18n="List">Refferal</span></a>
                        </li>
                        <li><a class="d-flex align-items-center"
                                href="{{ route('user.my-reEntry') }}"><i
                                    data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">My
                                    Team</span></a>
                        </li>
                        <li><a class="d-flex align-items-center"
                                href="{{ route('user.AutoPoolBonus') }}"><i
                                    data-feather="circle"></i><span class="menu-item text-truncate"
                                    data-i18n="FAQ">AutoPool Profit</span></a>
                        </li>
                        <li><a class="d-flex align-items-center"
                                href="{{ route('user.level-team') }}"><i
                                    data-feather="circle"></i><span class="menu-item text-truncate"
                                    data-i18n="List">Level Team</span></a>
                        </li>
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="list"></i><span
                    ...
                    <ul class="menu-content">
                        <li><a class="d-flex align-items-center"
                                href="{{ route('user.level-income') }}"><i
                                    data-feather="circle"></i><span class="menu-item text-truncate"
                                    data-i18n="Profile">Level Profit</span></a>
                        </li>
                        <li><a class="d-flex align-items-center"
                                href="{{ route('user.direct-income') }}"><i
                                    data-feather="circle"></i><span class="menu-item text-truncate"
                                    data-i18n="Profile">Direct Profit</span></a>
                        </li>
                        <li><a class="d-flex align-items-center"
                                href="{{ route('user.AutoPool-income') }}"><i
                                    data-feather="circle"></i><span class="menu-item text-truncate"
                                    data-i18n="FAQ">AutoPool Profit</span></a>
                        </li>
                        <li><a class="d-flex align-items-center"
