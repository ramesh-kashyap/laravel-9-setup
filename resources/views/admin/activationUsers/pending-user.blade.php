<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Users /</span> Pending users
        </h4>
        ...
        <div class="card">
            ...
            <div class="card-datatable text-nowrap">
              <form class="form-repeater" style="margin-left: 14px;"  method="GET" action="{{route('admin.pending-users')}}">
                    ...
                    <div data-repeater-item="">
                        <div class="row">
                            ...
                            <div class="mb-3 col-lg-6 col-xl-2 col-12 mb-0" >
                                ...
                                <a href="{{ route('admin.pending-users') }}" class="btn btn-danger waves-effect waves-light search-button">
                                  Reset
                                </a>
                            </div>
                        </div>
                    ...
                    <tbody>
                        ...
                        @foreach ($active_user as $value)
                            <tr>
                                ...
                                <td>{{ $value->adate }}</td>
                                <td><span
                                        class="badge bg-{{ $value->active_status == 'Pending' ? 'danger' : 'success' }}">{{ $value->active_status }}</span>
                                </td>
